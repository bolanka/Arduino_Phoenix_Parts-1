 ...
 * Date: 29-10-2009
 * Programmer: Frank Friedhof, code formatting, some clean up
...
// NOTE: This is not working with Due! Has no EEPROM.
 ...
 * Tables and arrays
 *
 * NOTE: many of these tables and arrays are constant, so they afre place into
 *       flash mem (PROGMEM), see https://www.arduino.cc/en/Reference/PROGMEM
 *
 * ArcCosinus Table
...
static const byte GetACos[] PROGMEM = {    
  255, 254, 252, 251, 250, 249, 247, 246, 245, 243, 242, 241, 240, 238, 237, 236, 234,
  233, 232, 231, 229, 228, 227, 225, 224, 223, 221, 220, 219, 217, 216, 215, 214, 212,
  211, 210, 208, 207, 206, 204, 203, 201, 200, 199, 197, 196, 195, 193, 192, 190, 189,
  188, 186, 185, 183, 182, 181, 179, 178, 176, 175, 173, 172, 170, 169, 167, 166, 164,
  163, 161, 160, 158, 157, 155, 154, 152, 150, 149, 147, 146, 144, 142, 141, 139, 137,
  135, 134, 132, 130, 128, 127, 125, 123, 121, 119, 117, 115, 113, 111, 109, 107, 105,
  103, 101,  98,  96,  94,  92,  89,  87,  84,  81,  79,  76,  73,  73,  73,  72,  72,
   72,  71,  71,  71,  70,  70,  70,  70,  69,  69,  69,  68,  68,  68,  67,  67,  67,
   66,  66,  66,  65,  65,  65,  64,  64,  64,  63,  63,  63,  62,  62,  62,  61,  61,
   61,  60,  60,  59,  59,  59,  58,  58,  58,  57,  57,  57,  56,  56,  55,  55,  55,
   54,  54,  53,  53,  53,  52,  52,  51,  51,  51,  50,  50,  49,  49,  48,  48,  47,
   47,  47,  46,  46,  45,  45,  44,  44,  43,  43,  42,  42,  41,  41,  40,  40,  39,
   39,  38,  37,  37,  36,  36,  35,  34,  34,  33,  33,  32,  31,  31,  30,  29,  28,
   28,  27,  26,  25,  24,  23,  23,  23,  23,  22,  22,  22,  22,  21,  21,  21,  21,
   20,  20,  20,  19,  19,  19,  19,  18,  18,  18,  17,  17,  17,  17,  16,  16,  16,
   15,  15,  15,  14,  14,  13,  13,  13,  12,  12,  11,  11,  10,  10,   9,   9,   8,
    7,   6,   6,   5,   3,   0 };

/* 
 * Sine table 90 deg, precision 0.5 deg [180 values] 
 */
static const word GetSin[] PROGMEM = {
     0,   87,  174,  261,  348,  436,  523,  610,  697,  784,  871,  958, 1045, 1132, 1218, 1305,
  1391, 1478, 1564, 1650, 1736, 1822, 1908, 1993, 2079, 2164, 2249, 2334, 2419, 2503, 2588, 2672,
  2756, 2840, 2923, 3007, 3090, 3173, 3255, 3338, 3420, 3502, 3583, 3665, 3746, 3826, 3907, 3987,
  4067, 4146, 4226, 4305, 4383, 4461, 4539, 4617, 4694, 4771, 4848, 4924, 4999, 5075, 5150, 5224,
  5299, 5372, 5446, 5519, 5591, 5664, 5735, 5807, 5877, 5948, 6018, 6087, 6156, 6225, 6293, 6360,
  6427, 6494, 6560, 6626, 6691, 6755, 6819, 6883, 6946, 7009, 7071, 7132, 7193, 7253, 7313, 7372,
  7431, 7489, 7547, 7604, 7660, 7716, 7771, 7826, 7880, 7933, 7986, 8038, 8090, 8141, 8191, 8241,
  8290, 8338, 8386, 8433, 8480, 8526, 8571, 8616, 8660, 8703, 8746, 8788, 8829, 8870, 8910, 8949,
  8987, 9025, 9063, 9099, 9135, 9170, 9205, 9238, 9271, 9304, 9335, 9366, 9396, 9426, 9455, 9483,
  9510, 9537, 9563, 9588, 9612, 9636, 9659, 9681, 9702, 9723, 9743, 9762, 9781, 9799, 9816, 9832,
  9848, 9862, 9876, 9890, 9902, 9914, 9925, 9935, 9945, 9953, 9961, 9969, 9975, 9981, 9986, 9990,
  9993, 9996, 9998, 9999, 10000 };
/*****************************************************************************/
...
// We can set different angles for the legs than just where they servo horns are set...
const short cCoxaInitAngle1[] PROGMEM = { cRRInitCoxaAngle1, cRMInitCoxaAngle1, cRFInitCoxaAngle1, cLRInitCoxaAngle1, cLMInitCoxaAngle1, cLFInitCoxaAngle1};
#endif
...
/*
 * global GetSinCos / ArcCos results
 */
...
// };  
extern "C" {
  // program space suck, to complicated printing on terminal
...
/* 
 * the main arduino setup function.
 */
void setup(){

#ifdef OPT_SKETCHSETUP
  SketchSetup();
#endif  // OPT_SKETCHSETUP

  g_fShowDebugPrompt = true;
  g_fDebugOutput = false;
  g_fMonitorOutput = false;
  ...
  // Input Y offset value to adjust centerpoint of rotation
  ...
  // added to try to adjust starting positions depending on height...
  g_InControlState.ForceGaitStepCnt = 0;
  g_InControlState.GaitStep = 1;
  GaitSelect();

#ifdef cTurretRotPin
  // Rotation of turret in 10ths of degree
  g_InControlState.TurretRotAngle1 = cTurretRotInit;
  // the tile for the turret
  ...
  // do some voltage measurements, to get some good values and avoid
  // power OFF at the beginning
  for (int i = 0; i < 8; i++) {
    CheckVoltage();
...
/*
 * Loop()
 * purpose:  the main arduino main Loop function
 */
void loop(void) {
  // Start time
  ...
  if (g_InControlState.BalanceMode) {
    ...
    for (LegIndex = 0; LegIndex < (CNT_LEGS/2); LegIndex++) {
      ...
      DoBackgroundProcess();
      BalCalcOneLeg(
        -LegPosX[LegIndex]+GaitPosX[LegIndex],
  ...
  for (LegIndex = 0; LegIndex < (CNT_LEGS/2); LegIndex++) {    
    ...
    BodyFK(
      -LegPosX[LegIndex]+g_InControlState.BodyPos.x+GaitPosX[LegIndex] - TotalTransX,
    ...
    LegIK(
      LegPosX[LegIndex]-g_InControlState.BodyPos.x+BodyFKPosX-(GaitPosX[LegIndex] - TotalTransX),
  ...
  if (g_InControlState.fRobotOn) {
    ...
    /* note we broke up the servo driver into start/commit that way we can output
     * all of the servo information before we wait and only have the termination
     * information to output after the wait.  That way we hopefully be more
     * accurate with our timings...
     */
    DoBackgroundProcess();
    StartUpdateServos();

    /* See if we need to sync our processor with the servo driver while walking
     * to ensure the prev is completed before sending the next one
     * ??? what, 2017-11-02, Frank
     */
    ...
    if (g_InControlState.fPrev_RobotOn || (AllDown= 0)) {
      ...
      // setup to process background stuff while we wait...
...
void StartUpdateServos() {        
  ...
  for (LegIndex = 0; LegIndex < CNT_LEGS; LegIndex++) {
    g_ServoDriver.OutputServoInfoForLeg(
      LegIndex, 
...
#ifdef cTurretRotPin
  g_ServoDriver.OutputServoInfoForTurret(
    g_InControlState.TurretRotAngle1,
    g_InControlState.TurretTiltAngle1);
#endif  // cTurretRotPin
}   // StartUpdateServos()
...
boolean CheckVoltage() {
  ...
  // Voltage = g_ServoDriver.GetBatteryVoltage();  // using SSC32U A/D interface
  Voltage = GetBatteryVoltage();  // using Arduino A/D interface
  //DBGSerial.print(F("Voltage : "));
  //DBGSerial.println(Voltage, DEC);
  Current = GetTotalCurrent();
  //DBGSerial.print(F("Current : "));
  //DBGSerial.println(Current, DEC);
  ...
  }  // !g_fLowVoltageShutdown
  else {
    // have voltage shut down
    if (s_bLVBeepCnt < 5) {
      s_bLVBeepCnt++;
...
/*
 * GaitSelect()
 * purpose: get actual gait sequence from APG and assign to current gait seqeunce
 */
...
#endif  // ADD_GAITS
#ifdef DISPLAY_GAIT_NAMES
    DBGSerial.print("Gait type : ");
    DBGSerial.println(g_InControlState.gaitCur.pszName);
#endif  // DISPLAY_GAIT_NAMES
  }
...
void GaitSeq(void) {
   ...
   * If not if we are going to start a motion try to align our Gaitstep to start
   * with a good foot for the direction we are about to go...
   */
 ...
 * purpose: why is this body FK when it's done for every leg?
 *
...
/******************************************************************************
 * LegIK
 * purpose: Calculates the angles of the coxa, femur and tibia for the given
...
//Vector value, the 2 DoF IK calcs (femur and tibia) are based upon these vectors
#define TarsOffsetY  0

  // Calculate IKCoxaAngle and IKFeetPosXZ
  GetATan2 (IKFeetPosX, IKFeetPosZ);
  CoxaAngle1[LegIKLegNr] =
    (((long)Atan4 * 180) / 3141) + (short)pgm_read_word(&cCoxaAngle1[LegIKLegNr]);
  ...
  Temp1 =
    ((((long)(byte)pgm_read_byte(&cFemurLength[LegIKLegNr]) * (byte)pgm_read_byte(&cFemurLength[LegIKLegNr])) -
...
#ifndef OPT_WALK_UPSIDE_DOWN
  // Normal
  FemurAngle1[LegIKLegNr] =
    -(long)(IKA14 + IKA24) * 180 / 3141 + 900 + CFEMURHORNOFFSET1(LegIKLegNr);
#else
  // IKFemurAngle
  if (g_fRobotUpsideDown) {
  ...
  if (g_fRobotUpsideDown)
    ...
    TibiaAngle1[LegIKLegNr] =
      (1800 - (long)AngleRad4 * 180 / 3141 + CTIBIAHORNOFFSET1(LegIKLegNr));
  else
  ...
  // !!!!!!!!!!!! 145 instead of 1800  
  TibiaAngle1[LegIKLegNr] =
    -(1450 - (long)AngleRad4 * 180 / 3141 + CTIBIAHORNOFFSET1(LegIKLegNr));
#else
  // normal case
  TibiaAngle1[LegIKLegNr] =
    -(900 - (long)AngleRad4 * 180 / 3141 + CTIBIAHORNOFFSET1(LegIKLegNr));
#endif  // PHANTOMX_V2
#endif  // OPT_WALK_UPSIDE_DOWN

  // Set the Solution quality    
  if(IKSW2 < ((word)((byte)pgm_read_byte(&cFemurLength[LegIKLegNr]) +
                     (byte)pgm_read_byte(&cTibiaLength[LegIKLegNr]) - 30) * c2DEC))
    IKSolution = 1;
  else if(IKSW2 < ((word)((byte)pgm_read_byte(&cFemurLength[LegIKLegNr]) +
                     (byte)pgm_read_byte(&cTibiaLength[LegIKLegNr])) * c2DEC)) 
    IKSolutionWarning = 1;
  else
    IKSolutionError = 1    ;
...
/******************************************************************************
 * [CHECK SERVO ANGLE BOUNDS]
 * purpose: Checks the mechanical limits of the servos
 *
 * Pull into simple function as so I can report errors on debug 
 * Note sID is bogus, but something to let me know which one.
 */
...
#endif  // SERVOS_DO_MINMAX
}   // CheckAngles


/******************************************************************************
 * SmoothControl, by Zenta
 * purpose: This function makes the body rotation and translation much smoother
 */
...
/******************************************************************************
 * GetLegsXZLength
 * purpose: calculates leg length within X,Z axis; sqrt(X^2 + Z^2)
 */
static word g_wLegsXZLength = 0xffff;
...
/******************************************************************************
 * AdjustLegPositions()
 * purpose: Will adjust the init leg positions to the width passed in.
 */
...
#define MAX_XZ_LEG_ADJUST (cCoxaLength[0]+cTibiaLength[0] + cFemurLength[0]/4) 
  ...
  // Make sure we cycle through one gait to have the legs all move into their
  // new locations...
...
/******************************************************************************
 * ResetLegInitAngles()
 * purpose: This is used when we allow the user to adjust the leg position
 *          angles. This resets to what it was when the the program was started.
 */
...
#ifdef cRRInitCoxaAngle1
    // We can set different angles for the legs than just where they servo horns are set...
    g_InControlState.aCoxaInitAngle1[LegIndex] =
      (short)pgm_read_word(&cCoxaInitAngle1[LegIndex]);
#else
    g_InControlState.aCoxaInitAngle1[LegIndex] =
      (short)pgm_read_word(&cCoxaAngle1[LegIndex]);
#endif  // cRRInitCoxaAngle1
  }
...
/******************************************************************************
 * ResetLegInitAngles
 * purpose: This is used when we allow the user to (to what? 2017-11-03, Frank)
 */
 ...
 * purpose:  Will try to adjust the position of the legs to be appropriate for
 *           the current y location of the body...
 */
void AdjustLegPositionsToBodyHeight() {

#ifdef CNT_HEX_INITS
  static uint8_t g_iLegInitIndex = 0x00;    // remember which index we are currently using...
...
/******************************************************************************
 * SoundNoTimer
 * purpose: Quick and dirty tone function to try to output a frequency to a
 *          speaker for some simple sounds.
 *
...
/******************************************************************************
 * TerminalMonitor
 * purpose: Simple background task checks to see if the user is asking us to do
 *          anything, like update debug levels ore the like.
 */
boolean TerminalMonitor(void) {
  ...
  if (g_fShowDebugPrompt) {
    ...
    DBGSerial.println(F("M - Toggle monitor on or off"));
    ...
    // Allow the input controller to define stuff as well
    g_InputController.ShowTerminalCommandList(); 
#endif  // OPT_TERMINAL_MONITOR_IC
  ...
  if ((ich = DBGSerial.available())) {
    ich = 0;
    // For now assume we receive a packet of data from serial monitor, as the
    // user has to click the send button...
    ...
    if (!ich) {
      ...
      g_fMonitorOutput = !g_fMonitorOutput;
      if (g_fMonitorOutput) 
        DBGSerial.println(F("Monitor (voltage,current) is on"));
      else
        DBGSerial.println(F("Monitor is off"));
    }
...
/******************************************************************************
 * GetCmdLineNum
 * purpose: passed pointer to pointer so we can update...
 */
